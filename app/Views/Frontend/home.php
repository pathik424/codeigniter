			...
			<div class="col-md-12">
				<div class="carousel-testimony owl-carousel ftco-owl">
					...
					<?php foreach ($client_feedbacks as $feedback): ?>
						...
						<div class="item">
							<div class="testimony-wrap py-4 test">
								<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></span></div>
								<div class="text">
									<p class="mb-4"><?= substr(esc($feedback['client_feedback']), 0, 110) ?></p>
									<div class="d-flex align-items-center">
										<?php
										$image = !empty($feedback['client_profile_image'])
											? base_url('uploads/feedbacks/' . $feedback['client_profile_image'])
											: base_url('FontendAssets/images/default-user.jpg'); // fallback
										?>

										<div class="user-img" style="background-image: url('<?= $image ?>')"></div>

										<div class="pl-3">
											<p class="name"><?= esc($feedback['client_name']) ?></p>
											<span class="position"><?= esc($feedback['client_position']) ?></span>
										</div>
									</div>
								</div>
							</div>
