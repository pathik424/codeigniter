					...
					<div class="col-md-12">
						<div class="wrapper">
							...
							<?php
							        ...
							        $addrAddress = $store_address['address'] ?? '';
							        $addrPhone   = $store_address['phone']   ?? '';
							        $addrEmail   = $store_address['email']   ?? '';
							        $addrWeb     = $store_address['website'] ?? '';
							        ?>
								<div class="col-md-3">
									<div class="dbox w-100 text-center">
					 					...
					 					<div class="text">
					 					    <p><span>Address:</span> <?php echo esc($addrAddress); ?></p>
					 					  </div>
					 					</div>
								</div>
								<div class="col-md-3">
									<div class="dbox w-100 text-center">
					 					...
					 					<div class="text">
					 					    <p><span>Phone:</span> <a href="tel:<?php echo esc($addrPhone); ?>"><?php echo esc($addrPhone ?: '+ 1235 2355 98'); ?></a></p>
					 					  </div>
					 					</div>
								</div>
								<div class="col-md-3">
									<div class="dbox w-100 text-center">
					 					...
					 					<div class="text">
					 					    <p><span>Email:</span> <a href="mailto:<?php echo esc($addrEmail); ?>"><?php echo esc($addrEmail ?: 'info@yoursite.com'); ?></a></p>
					 					  </div>
					 					</div>
								</div>
								<div class="col-md-3">
									<div class="dbox w-100 text-center">
					 					...
					 					<div class="text">
					 					    <p><span>Website</span> <a href="<?php echo esc($addrWeb ?: '#'); ?>"><?php echo esc($addrWeb ?: 'yoursite.com'); ?></a></p>
					 					  </div>
					 					</div>
								</div>
							...
							<div class="row no-gutters">
								<div class="col-md-7">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<?php endif; ?>
										<form method="POST" action="<?= site_url('contact_us'); ?>" id="contactForm" name="contactForm" class="contactForm">
											<?= csrf_field(); ?>
											<div class="row">
												<div class="col-md-6">
								...
								<div class="col-md-5 d-flex align-items-stretch">
									<div class="info-wrap w-100 p-5 img" style="background-image: url('<?php echo base_url('FontendAssets/images/img.jpg'); ?>'">
				          </div>
								</div>
							</div>
						</div>
